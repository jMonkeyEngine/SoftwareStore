...
Head over to the [docs](http://bgrins.github.io/spectrum) for more details.  There is a visual demo of the different options hosted at: http://bgrins.github.io/spectrum.
...
If you'd like to run the development version, spectrum uses Grunt to automate the testing, linting, and building.  Head over to http://gruntjs.com/getting-started for more details.  First, clone the repository, then run:
